        ...
        <div class="container">
           <div class="row">
              <div class="col-lg-12 text-center mb-lg-5">
                 <h2 class="hm-head">Register Now!</h2>
              </div>
           </div>
           <div class="row justify-content-center">
              <div class="col-lg-8">
                    ...
                    <form method="POST" action="{{ route('register') }}" id="login-form">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                             <div class="form-group">
                                <label>User Name</label>
                                <input type="text" required="required" class="form-control" name="username" id="user_name">
                                @error('username')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="col-lg-12">
                             <div class="form-group">
                                <label>Confirm Password</label>
                                <input type="password" required="required" class="form-control" name="password_confirmation" id="cPassword">
                                @error('password_confirmation')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="col-lg-12">
                             <div class="form-group">
                                ...
                                <input type="text" required="required" class="form-control" name="name" id="full_name">
                                @error('name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="col-lg-12">
                             <div class="form-group">
                                <label>Phone</label>
                                <input type="tel" required="required" class="form-control" name="phone" id="form_Phone">
                                @error('phone')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="col-lg-12">
                             <div class="form-group">
                                <label>Email</label>
                                <input type="text" required="required" class="form-control" name="email" id="form_Email">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
