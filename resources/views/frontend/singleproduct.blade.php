    ...
    <section id="inn-section">
        <div class="container">
                ...
                {{-- <ul class="pb-list">
                 ...
                 <ul class="pro-qty-list">
                    ...
                    <li>
                        @auth
                            @if ($singleProduct->carts->count() > 0)
                                <a href="{{ route('cart') }}" class="banner-btn"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Already Added to Bag</a>
                            @else
                                <a onclick="addToCart({{ $singleProduct->id }})" class="banner-btn"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Add To Bag</a></li>
                            @endif
                        @else
           ...
           <div class="row justify-content-between border-bottom mb-3 rev-box">
              ...
              <div class="col-lg-3 col-sm-6 col-5 rev-brnBox">
                 <a href="" class="shop-btn" data-toggle="modal" data-target="#exampleModal-Rev">Write A Review</a>
              </div>
              <div class="modal fade" id="exampleModal-Rev" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                 <div class="modal-dialog" role="document">
                    <div class="modal-content">
                       <div class="modal-header">
                          <h5 class="modal-title" id="exampleModalLabel">Write A Review</h5>
                          ...
                          @csrf
                             <div class="controls">
                                ...
                                <div class="row">
                                   <div class="col-md-12">
                                      <div class="form-group">
                                         <textarea id="form_message" name="note" class="form-control" placeholder="Tell us your feedback about the product..." rows="4" required="required" data-error="Please,leave us a message."></textarea>
                                      </div>
                                   </div>
                                   <div class="col-md-12">
                                      <input type="submit" class="banner-btn" value="Submit Now">
           ...
           <div class="row mt-5">
              <div class="col-lg-12 mb-3 text-center">
                 <h2 class="hm-head">Related Products</h2>
              </div>
              <div class="col-lg-12">
                 <div id="demo-pranab">
                    <div id="owl-related-product" class="owl-carousel owl-theme">
                        @forelse ($relatedProducts as $relatedProductT)
                            <div class="item">
                                <div class="pro-box">
                                    <img src="{{ asset('storage/' . $relatedProductT?->productPrimaryImage?->image_path) }}" class="img-fluid mb-lg-4" alt="...">
                                    <h3>{{ $relatedProductT?->name }}</h3>
                                    <p class="price-txt">₹ {{ $relatedProductT?->productVariantPrice?->price }}</p>
                                    <ul class="pb-list">
                                    ...
                                    <a href="{{ route('singleProduct', $relatedProductT->slug) }}" class="shop-btn"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Add To Cart</a>
                                </div>
                            </div>
                        @empty
                        @endforelse
